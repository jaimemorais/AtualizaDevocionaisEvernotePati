...
using AtualizaDevocionalEvernotePat.Models;
using System;
...
namespace AtualizaDevocionalEvernotePat.Controllers
{
    public class HomeController : Controller
    {
        ...
        EvernoteAuthorizer EvernoteAuthorizer = new EvernoteAuthorizer(
            ConfigurationManager.AppSettings["Evernote.Url"], 
            ConfigurationManager.AppSettings["Evernote.Key"], 
            ConfigurationManager.AppSettings["Evernote.Secret"]);
